  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-sky-50">
      <header className="sticky top-0 z-10 w-full border-b border-gray-100 bg-white/80 backdrop-blur-md">
        <div className="mx-auto flex max-w-2xl items-center justify-between gap-3 px-4 py-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-xl font-black leading-tight text-transparent">
                赤ちゃんの衣替え
              </h1>
          ...
          <nav className="flex items-center gap-3 text-xs font-black uppercase tracking-[0.2em] text-gray-400">
            ...
            <Link href="/work" className="transition hover:text-blue-600">Work</Link>
          </nav>
        </div>
      </header>
      ...
      <footer className="mt-20 border-t border-gray-100 py-10 text-center">
        ...
        <p className="text-xs font-bold text-gray-400">娘の毎日を、もっと快適に 👶</p>
      </footer>
    </div>
  );
}
